...
function activate(context) {
    ...
    const storage = context.globalState.get(STORAGE_KEY) || {};
    ...
    context.subscriptions.push(toggleCommand, vscode.window.onDidChangeActiveTextEditor(editor => updateProgress(editor)), onTextChange, onWindowStateChange);
